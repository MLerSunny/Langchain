...
class TestDeepseekChatbot:
    ...
    @pytest.mark.skip(reason="App initialization cannot be tested meaningfully in this environment.")
    ...
    def test_model_parameters(self, mock_streamlit, mock_llm_engine):
    ...
    def test_response_generation(self, mock_streamlit, mock_llm_engine):
    ...
    def test_context_trimming(self, mock_streamlit):
